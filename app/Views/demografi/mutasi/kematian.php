...
<div class="container-fluid py-4">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h2 class="mb-1">
                <i class="fas fa-cross me-2 text-danger"></i>Pencatatan Kematian
            </h2>
        ...
        <div class="col-lg-8">
            <div class="card border-0 shadow-sm">
                <div class="card-header bg-danger text-white py-3">
                    <h5 class="mb-0"><i class="fas fa-cross me-2"></i>Form Pencatatan Kematian</h5>
                </div>
                <div class="card-body">
                    <form action="<?= base_url('/demografi/mutasi/kematian/save') ?>" method="POST">
                        <?= csrf_field() ?>
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-12">
                                ...
                                <textarea name="keterangan" class="form-control" rows="3" 
                                          placeholder="Penyebab kematian, tempat meninggal, dll"></textarea>
                            </div>
                        </div>
                        ...
                        <div class="d-flex justify-content-between">
                            ...
                            <button type="submit" class="btn btn-danger">
                                <i class="fas fa-save me-2"></i>Simpan Data Kematian
                            </button>
                        </div>
                    </form>
                </div>
            ...
            <div class="card border-0 shadow-sm">
                ...
                <div class="card-body">
                    <div class="alert alert-warning">
                        ...
                        <p class="mb-0 mt-2">Pencatatan kematian akan mengubah status penduduk menjadi <strong>MATI</strong> dan tidak dapat dibatalkan.</p>
                    </div>
                    
                    <h6>Yang akan terjadi:</h6>
                    <ul class="mb-0">
                        <li>Status penduduk berubah menjadi <span class="badge bg-dark">MATI</span></li>
